...
rotas.get("/usuarios/:id", usuarios.listarId);
rotas.post("/usuarios", usuarios.postar);
rotas.put("/usuarios/:id", usuarios.atualizar);
rotas.delete("/usuarios/:id", usuarios.excluir);

// emprestimos
rotas.get("/emprestimos", emprestimos.listar);
rotas.get("/emprestimos/:id", emprestimos.listarID);
rotas.post("/emprestimos", emprestimos.postar);
rotas.put("/emprestimos/:id", emprestimos.atualizar);
rotas.delete("/emprestimos/:id", emprestimos.excluir);
